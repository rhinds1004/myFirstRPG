...
namespace Engine
{
    public static class RandomNumberGenerator
    {
        ...
        public static int NumberBetween(int minimumValue, int maximumValue)
        {
            ...
            //Using Math.Max, and subtracting 0.00000000001 to ensure "multipler"
            //will always be between 0.0 and .99999999999
            //Otherwise, it is possible for it to be "1', which causes problems in rounding.
        ...
        {
            return _simpleGenerator.Next(minimumValue, maximumValue + 1); //to make maximumValue actually reach the next whole integer. Otherwise will be n.99999999
        }
    }
}
